...
if ( ! class_exists( 'Techmarket' ) ) :
	...
	class Techmarket {
		...
		public function scripts() {
			 ...
			 * Styles
			 */
			wp_enqueue_style( 'techmarket-style', get_template_directory_uri() . '/style.css', '', $techmarket_version );
			...
			wp_enqueue_script( 'techmarket-waypoints', get_template_directory_uri() . '/assets/js/jquery.waypoints.min.js', array( 'jquery' ), '4.0.0', true );
		...
		public function required_plugins() {
			$plugins = apply_filters( 'techmarket_tgmpa_plugins', array(
				...
				array(
					...
					'source'				=> get_template_directory() . '/assets/plugins/techmarket-extensions.zip',
					'required'				=> false,
					'version'				=> '1.1.0',
					'force_activation'		=> false,
					'force_deactivation'	=> false,
