...
if ( ! function_exists( 'techmarket_cart_link' ) ) {
	...
	function techmarket_cart_link() {
		?>
		<a class="cart-contents" href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" data-toggle="dropdown" title="<?php esc_attr_e( 'View your shopping cart', 'techmarket' ); ?>">
	...
	function techmarket_header_compare() {
		if( function_exists( 'techmarket_get_compare_page_url' ) ) {
			...
			<ul class="header-compare nav navbar-nav">
				<li class="nav-item">
					<a href="<?php echo esc_attr( techmarket_get_compare_page_url() ); ?>" class="nav-link"><i class="tm-compare-icon <?php echo esc_attr( apply_filters( 'techmarket_compare_icon', 'tm tm-compare' ) ); ?>"></i><span id="top-cart-compare-count" class="value"><?php echo count( $yith_woocompare->obj->products_list ); ?></span></a>
				</li>
			</ul>
			<?php
		}
	...
	function techmarket_header_wishlist() {
		if( function_exists( 'techmarket_get_wishlist_url' ) ) {
			...
			<ul class="header-wishlist nav navbar-nav">
				<li class="nav-item">
					<a href="<?php echo esc_attr( techmarket_get_wishlist_url() ); ?>" class="nav-link"><i class="tm-wishlist-icon <?php echo esc_attr( apply_filters( 'techmarket_wishlist_icon', 'tm tm-favorites' ) ); ?>"></i><span id="top-cart-wishlist-count" class="value"><?php echo yith_wcwl_count_products(); ?></span></a>
				</li>
			</ul>
			<?php
		}
...
if ( ! function_exists( 'techmarket_handheld_header_cart_link' ) ) {
	...
	function techmarket_handheld_header_cart_link() {
		?>
			<a class="handheld-header-cart-link has-icon" href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'techmarket' ); ?>">
