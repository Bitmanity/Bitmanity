...
if ( techmarket_is_yith_wcwl_activated() ) {
	...
	if ( ! function_exists( 'techmarket_handheld_header_wishlist_link') ) {
		function techmarket_handheld_header_wishlist_link() { ?>
			<a href="<?php echo esc_attr( techmarket_get_wishlist_url() ); ?>" class="has-icon"><i class="tm-wishlist-icon <?php echo esc_attr( apply_filters( 'techmarket_wishlist_icon', 'tm tm-favorites' ) ); ?>"></i><span class="count"><?php echo yith_wcwl_count_products(); ?></span></a><?php
		}
	}
}
...
if( techmarket_is_yith_woocompare_activated() ) {
	...
	if ( ! function_exists( 'techmarket_handheld_header_compare_link') ) {
		function techmarket_handheld_header_compare_link() { 
			global $yith_woocompare; ?>
			<a href="<?php echo esc_attr( techmarket_get_compare_page_url() ); ?>" class="has-icon"><i class="tm-compare-icon <?php echo esc_attr( apply_filters( 'techmarket_compare_icon', 'tm tm-compare' ) ); ?>"></i><span class="count"><?php echo count( $yith_woocompare->obj->products_list ); ?></span></a><?php
		}
	}
}
